 ...
 * @version		1.0
 * @filesource 	./mithra62/tests/Browser/WP/SettingsTest.php
 */
...
/**
 * mithra62 - WordPress Browser (Selenium) Settings object Unit Tests
 *
...
class SettingsTest extends SettingsTestAbstract 
{
    ...
    public $test_settings = array(
        ...
        'backup_file_location' => array('D:\ProjectFiles\mithra62\clean_cms\wp\html'),
