...
abstract class S3Engine extends TestFixture
{
    ...
    public function testAddS3AccessKeyNoValue()
    {
        ...
        $this->assertTrue($this->session->getPage()
            ->hasContent('S3 Access Key is required'));
        $this->assertTrue($this->session->getPage()
            ->hasContent('Can\'t connect to S3 Access Key'));
    }
    ...
    public function testAddS3SecretKeyNoValue()
    {
        ...
        $this->assertTrue($this->session->getPage()
            ->hasContent('S3 Secret Key is required'));
    }
    ...
    /**
     * @depends testAddCompleteS3Storage
     */
    public function testBackupDatabaseS3Storage()
    {
