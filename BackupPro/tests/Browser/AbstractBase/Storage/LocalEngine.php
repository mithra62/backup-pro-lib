...
{   
    ...
    public function testAddLocalStorageBackupStoreLocationNoValue()
    {
        ...
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location is required'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be a directory'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be writable'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be readable'));
    }
    ...
    public function testAddLocalStorageBackupStoreLocationBadValue()
    {
        ...
        $this->assertNotTrue($this->session->getPage()->hasContent('Backup Store Location is required'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be a directory'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be writable'));
        $this->assertTrue($this->session->getPage()->hasContent('Backup Store Location has to be readable'));
    }
    ...
    public function testAddLocalStorageBackupStoreLocationGoodValue()
    {
        ...
        $this->assertNotTrue($this->session->getPage()->hasContent('Backup Store Location is required'));
        $this->assertNotTrue($this->session->getPage()->hasContent('Backup Store Location has to be a directory'));
        $this->assertNotTrue($this->session->getPage()->hasContent('Backup Store Location has to be writable'));
        $this->assertNotTrue($this->session->getPage()->hasContent('Backup Store Location has to be readable'));
    }
