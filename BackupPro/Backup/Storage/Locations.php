...
class Locations
{
     ...
     * @param \mithra62\BackupPro\Backup\Storage $storage The Storage object
     ...
     * @param string $location_id The storage ID for the location we want to check out
     * @param array $backups The backups to weed through
     ...
     * @param \mithra62\Settings $settings The Settings object to save the Location data
     * @param string $driver The name of the driver we're using
     * @param array $data
     */
     ...
     * @param \mithra62\Settings $settings The Settings object to save the Location data
     * @param string $storage_id The storage location we're updating
     * @param array $data The name of the driver we're using
     * @return boolean
     */
     ...
     * @param string $storage_id The storage location we're removing
     * @param array $data The configuration data to determine how deep we want to go
     * @param array $backups
     * @return boolean
     */
    public function remove($storage_id, array $data, array $backups = array())
    {
        ...
        if( !empty($_settings['storage_details'][$storage_id]) )
        {
            $obj = $this->getContext()->getDriver($_settings['storage_details'][$storage_id]['storage_location_driver'])->setSettings($_settings['storage_details'][$storage_id]);
