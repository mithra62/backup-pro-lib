...
class AbstractDb
{
 ...
 // end function
     ...
     *
     * @param boolean $theTextFlag
     *            [optional] If true, the error text is returned
     *            as a string.
 ...
 // end function
     ...
     * @access public
     * @param
     *            resource [optional] The result from which data is to be fetched.
     ...
     * @access public
     * @param
     *            resource [optional] the result from which the next row is to be fetched.
     * @return mixed an array containing a DB record.
     */
     ...
     *
     * @access public
     * @param boolean $theAssocFlag
     *            True if an associative array is to be returned,
     *            false otherwise.
 ...
 // end function
     ...
     * return the last inserted primary key number.
     * Many databases have a notion
     ...
     *
     * @param
     *            string [optional] the name of the sequence whose current value is to be returned.
     * @return int
     * @access public
     *         @scope public
     * @since version 1.0.1
    ...
    public function fetchLastInsertId($theSequenceName = NULL)
    {
        ...
        if (! $this->last_insert_id) {
            $this->returnError(sprintf('Unable to get the last inserted id from %s after query: %s', $this->db_specialization(), $this->lastQuery));
        }
 ...
 // end function
     ...
     *
     * @param
     *            boolean [optional] true if errors are to be captured, false otherwise. Default
     *            is FALSE.
 ...
 // end function
     ...
     * @access public
     * @param
     *            mixed Table Name(s). If an array is passed, the key is the table name and the value
